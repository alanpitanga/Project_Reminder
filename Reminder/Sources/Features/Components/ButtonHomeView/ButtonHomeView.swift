...
//  Reminder
//
//  Created by Alan Pitanga on 31/05/26.
//
...
class ButtonHomeView: UIView {
    ...
    init(icon: UIImage?, tittle: String, description: String) {
    ...
    private func setupUI(){
        ...
        NSLayoutConstraint.activate([
            ...
            titleLable.topAnchor.constraint(equalTo: topAnchor, constant: Metrics.medium),
            titleLable.leadingAnchor.constraint(equalTo: iconView.trailingAnchor, constant: 16),
            titleLable.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -16),

            descriptionLabel.topAnchor.constraint(equalTo: titleLable.bottomAnchor, constant: Metrics.medium),
            ...
            arrowImageView.centerYAnchor.constraint(equalTo: titleLable.centerYAnchor),
